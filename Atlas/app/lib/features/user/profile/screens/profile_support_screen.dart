...
class _ProfileSupportScreenState extends State<ProfileSupportScreen> {
  ...
  final List<_FaqItem> _faqs = const [
    ...
    _FaqItem(
      ...
      answer:
          'Transfers between Atlas accounts are processed instantly using our double-entry atomic ledger engine. Funds are debited and credited immediately with zero fee.',
    ),
    _FaqItem(
...
class _SupportChatSheetState extends State<_SupportChatSheet> {
  final List<Map<String, String>> _messages = [
    {'sender': 'bot', 'text': 'Hello! Welcome to Atlas Support. How can I assist you with your wallet today?'}
  ];
            ...
            children: [
              Row(
                children: [
                  ...
                  Text('Atlas Live Assistant', style: AppTypography.textTheme.titleMedium),
                ],
              ),
