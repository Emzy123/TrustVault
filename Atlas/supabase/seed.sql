-- Atlas seed: sample ledger data and queues.
...
BEGIN
  ...
  SELECT id INTO v_alice_id FROM public.profiles WHERE email = 'alice@atlas.demo';
  SELECT id INTO v_bob_id FROM public.profiles WHERE email = 'bob@atlas.demo';
  SELECT id INTO v_charlie_id FROM public.profiles WHERE email = 'charlie@atlas.demo';
  SELECT id INTO v_admin_id FROM public.profiles WHERE email = 'admin@atlas.demo';
  SELECT id INTO v_superadmin_id FROM public.profiles WHERE email = 'superadmin@atlas.demo';
  ...
  RAISE NOTICE 'Atlas seed successfully applied.';
END $$;
