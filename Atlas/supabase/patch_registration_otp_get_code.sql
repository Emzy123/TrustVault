-- Run this in the Atlas Supabase SQL Editor if "Get code" returns no active code.
-- Fixes get_registration_otp by storing a short-lived plain OTP on registration_otps.
