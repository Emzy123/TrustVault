# Hosting Atlas (Supabase + Flutter Web)

End-to-end checklist to run Atlas on **hosted Supabase** and a **static web host**.
...
```bash
cd /home/purist/Desktop/projects/Atlas
...
Atlas is a Flutter app. Vercel does **not** ship Flutter, so a deploy that only
