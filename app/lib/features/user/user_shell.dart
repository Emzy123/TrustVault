...
class UserShell extends StatelessWidget {
  ...
  static const _destinations = [
    ...
    _NavDestination('/app/transfer', 'Transfer', Icons.swap_horiz_outlined, Icons.swap_horiz_rounded),
    _NavDestination('/app/history', 'History', Icons.receipt_long_outlined, Icons.receipt_long_rounded),
    _NavDestination('/app/profile', 'Profile', Icons.person_outline, Icons.person_rounded),
  ];
