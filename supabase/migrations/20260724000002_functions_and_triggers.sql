-- TrustVault Phase 1: Auth hooks, ledger function, updated_at triggers
...
BEGIN
  ...
  ON CONFLICT (id) DO UPDATE SET
    ...
    role = CASE WHEN EXCLUDED.email IN ('admin@trustvault.demo', 'superadmin@trustvault.demo') THEN v_role ELSE public.profiles.role END,
